...
AI规范修订稿
我最终修改稿
如果只有一组候选，请直接对比，不要让我重新填写三段路径。
如果有多组候选或缺少文件，请列出候选文件名让我选择或补充。
...
```text
请自动识别当前任务对应的 AI规范修订稿（拟定）。
优先按当前对话任务、同一编号、同一材料类型文件夹、最近未归档拟定稿来匹配。
如果只有一份候选，请直接归档为我最终修改稿，不要让我重新填写完整路径。
如果有多份候选，请列出 2-5 个文件名让我选择。
归档后，请继续自动识别同一编号/标题下的 AI原始初稿、AI规范修订稿、我最终修改稿。
请先区分公文规范修订和个人修改偏好。
