...
3. 再复制一份 `AI规范修订稿（拟定）` 作为你的修改工作稿。

如果你的 AI 工具可以操作本地文件，Skill 应该自动保存这些稿件：

```text
年度工作总结 / AI原始初稿 / 002-季度工作总结-AI原始初稿.docx
年度工作总结 / AI规范修订稿 / 002-季度工作总结-AI规范修订稿.docx
年度工作总结 / 002-季度工作总结-AI规范修订稿（拟定）.docx
```

`AI规范修订稿` 文件夹里的版本是留痕稿，不建议直接修改。

你后面真正修改的，应该是 `AI规范修订稿（拟定）` 这一版。

等你确认已经定稿，再让 Skill 归档为：
